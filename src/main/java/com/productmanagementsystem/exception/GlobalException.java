...
public class GlobalException {
    ...
    public ResponseEntity<Response> handleDuplicateResourceException(DuplicateResourceException e) {
    ...
    public ResponseEntity<Response> handleValidationException(MethodArgumentNotValidException e) {
        ...
        return  ResponseEntity.status(HttpStatus.BAD_REQUEST).body(Response.error("400" , "fail"  ,"validation failed", errors));
    }
